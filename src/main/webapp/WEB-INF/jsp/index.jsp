...
<html lang="en">
    ...
    <body>
        <div class="main" id="home">
            ...
            <div class="banner">
                <!--Slider-->
                <img src="images/suroj-profile.jpg" alt=" " class="img-responsive">
                <h2>I'M Suroj Dangol</h2>
                <span>PROGRAMMER / Java DEVELOPER / Android DEVELOPER
                </span>
                ...
                <!--//Slider-->
                <ul class="top-links">
                    <li><a href="https://m.me/surojd" target="_blank"><i class="fa fa-facebook"></i></a></li>
                    <!--<li><a href="resources/#"><i class="fa fa-twitter"></i></a></li>-->
                    <li><a href="https://linkined.com/surojd"><i class="fa fa-linkedin"></i></a></li>
            ...
            <div class="w3l-grids-about">
                <div class="col-md-5 w3ls-ab-right">
                    <div class="agile-about-right-img">
                        <img src="images/suroj-big-profile.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-7 w3ls-agile-left">
                    <div class="w3ls-agile-left-info">
                        <h4>Job Title</h4>
                        <p>PROGRAMMER / Java DEVELOPER / Android DEVELOPER
                        </p>
                    </div>
                    <div class="w3ls-agile-left-info">
                        <h4>Name</h4>
                    ...
                    <div class="w3ls-agile-left-info">
                        <h4>Address</h4>
                        <p> Karyebinayek-9, Lalitpur, Nepal</p>
                    </div>
                    <div class="w3ls-agile-left-info">
                        <h4>Email Address</h4>
                        <p><a href="mailto:surojsmiling@gmail.com">surojsmiling@gmail.com</a></p>
                    </div>
                </div>
                <div class="clearfix">
                </div>
        ...
        <div class="col-md-6 education-w3l">
            ...
            <div class="education-agile-grids">
                ...
                <div class="education-agile-w3l">
                    ...
                    <div class="education-agile-w3l-info">
                        <h4>Shree Rudrayanee Sec. School</h4>
                        <p>SLC</p>                    
                    </div>
                    <div class="clearfix"></div>
                </div>    
    ...
    <div class="education" id="education two">
        <div class="col-md-6 skills two">
            ...
            <div class="skill-agile">
                ...
                <div class="col-sm-4 abt-gd-left text-center">		   
                    <div id="demo-pie-4" class="pie-title-center" data-percent="15">
                        <span class="pie-value"></span>
                    </div>
